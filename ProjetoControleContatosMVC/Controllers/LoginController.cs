            ...
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    if (usuario != null)
                    {
                        ...
                        string mensagem = $"Sua noa senha é:{novaSenha}";
                        ...
                        {
                            TempData["MensagemErro"] = $"Não conseguimos enviar o e-mail, verifique seus dados e tente novamente.";
                        }
             
                        return RedirectToAction("Index", "Login");
                    }

                    TempData["MensagemErro"] = $"Não conseguimos redefinir sua senha. Tente novamente.";
                }
                return View("Index");
            }
            catch (Exception erro)
